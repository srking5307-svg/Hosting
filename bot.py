    ...
    try:
        if action == 'edit_points':
            ...
            privacy_kb = InlineKeyboardMarkup([
                [InlineKeyboardButton("🔒 Privacy ON (no forward/screenshot)", callback_data="itemcodeprivacy_on")],
                [InlineKeyboardButton("🔓 Privacy OFF (normal message)", callback_data="itemcodeprivacy_off")]
            ])
            await update.message.reply_text(
                f"🔒 *Delivery Privacy*\n\n"
